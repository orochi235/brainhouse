 ...
 *
 * - `group` (workarea, main column): renders its own `Container` so the
 *   group's strip runs against the rect its parent gave it. Recurses
 *   indefinitely if more groups land later.
 * - `panel` (top/processes/main/sidebar slots): renders a slot wrapper whose body
...
export type SlotName = 'top' | 'processes' | 'main' | 'sidebar';
